...
function Admindashboard() {
  ...
  <Link to="addline" className="nav-link px-0 align-middle text-white">
    <i className="bi bi-plus"></i><span className="ms-1 d-none d-sm-inline">Add Production Lines</span>
  </Link>
</li>
<li>
  <Link to="all_lines" className="nav-link px-0 align-middle text-white">
    <i className="bi bi-list"></i><span className="ms-1 d-none d-sm-inline">All Production Lines</span>
  </Link>
</li>
